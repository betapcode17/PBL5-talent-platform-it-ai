...
from .context_packing import pack_context
from .embedding import EmbeddingService
from .evaluation import EvaluationCase, benchmark_retrieval
from .fallback import detect_low_confidence
...
from .response_formatter import build_structured_chat_response, format_chat_response
...
from .settings import QWEN_MODEL_NAME, RAG_DEFAULT_PROFILE, RAG_MAX_CHUNK_TOKENS, RAG_RETRIEVAL_TIMEOUT_MS, RAG_SYNC_INTERVAL_SECONDS
...
class RAGPipelineService:
    ...
    async def benchmark_retrieval(self, cases: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        return await asyncio.to_thread(benchmark_retrieval, self.retrieval, evaluation_cases)
