"""Token-aware context packing for stable prompt construction."""
...
def estimate_tokens(text: str) -> int:
    # Conservative approximation for mixed Vietnamese/English content.
...
def pack_context(
    ...
    for item in sorted_items:
        ...
        if text_tokens <= allowed_tokens:
            ...
            # Truncate by word budget approximation.
