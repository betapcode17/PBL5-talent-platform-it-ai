"""Embedding service with GPU-first sentence-transformers execution."""
...
from .settings import EMBED_BATCH_SIZE, EMBED_DEVICE, EMBED_MODEL_NAME, HF_LOCAL_FILES_ONLY, QWEN_ENFORCE_CUDA
...
class EmbeddingService:
    ...
    def _pick_device() -> str:
        ...
        # With lightweight embedding model (44MB) + Qwen 0.5B (600-900MB), 
        # we can fit both on 4GB GPU with some overhead
        if total_vram_gb < 2:
            logger.warning(
