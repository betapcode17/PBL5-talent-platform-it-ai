...
RAG_RERANK_PRESET = os.getenv("RAG_RERANK_PRESET", "balanced")  # balanced, semantic-first, bm25-first, hybrid
...
# Cross-encoder reranking (optional, premium feature)
...
# Full-text search hybrid mode (optional)
