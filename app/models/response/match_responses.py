"""
Match-related Pydantic models (MatchResponse, MatchInput).
"""

from pydantic import BaseModel, Field, ConfigDict, field_validator
from typing import List, Dict, Any, Optional
from models.core import Education, Experience, MatchedJob, ModelName, Suggestion  # Import from job_models
...
class MatchResponse(BaseModel):
    ...
    education: List[Education] = Field(default_factory=list, description="Học vấn")  # From cv_models
    experience: List[Experience] = Field(default_factory=list, description="Kinh nghiệm")  # From cv_models
